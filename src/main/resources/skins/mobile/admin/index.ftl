...
<div class="wrapper">
    <div class="vditor-reset ft-red">
        <ul>
            <li>BlueBook 社区版使用 AGPL 开源协议，请务必保证所有代码及其衍生代码开源，并在页脚放置开源库地址</li>
            <li>企业使用请购买商业授权，详情请看 <a href="https://b3log.org/bluebook/pricing.html" target="_blank">https://b3log.org/bluebook/pricing.html</a></li>
        </ul>
    </div>
